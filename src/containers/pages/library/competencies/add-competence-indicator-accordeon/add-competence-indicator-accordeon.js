...
class AddCompetenceIndicatorAccordeon extends Component {
    constructor(props){
        super(props);
    ...
    onIndicatorPointOut = indicator => {
        this.props.dispatch(updateNewCompetencePointedIndicators(indicator));
    }
...
export default connect(mapStoreToProps)(withStaffixService(AddCompetenceIndicatorAccordeon));